...
export const adminUsageCardsAPI = {
  ...
  listCards(
    ...
    return apiClient.get<BasePaginationResponse<UserUsageCard>>('/admin/usage-cards', {
      params,
  ...
  convertCardToBalance(id: number, reason?: string) {
    return apiClient.post<{ converted: boolean; amount_usd: number; new_balance_usd: number }>(`/admin/usage-cards/${id}/convert`, { reason })
  },
