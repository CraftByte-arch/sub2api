export default {
    settings: {
      ...
      customMenu: {
        title: '自定义菜单页面',
        description: '添加 URL、Markdown 或静态 HTML 页面到侧边栏导航，并设置可见角色。',
        itemLabel: '菜单项 #{n}',
        name: '菜单名称',
        namePlaceholder: '如：帮助中心',
        contentType: '内容类型',
        contentTypeUrl: '页面 URL',
        contentTypeMarkdown: 'Markdown',
        contentTypeHtml: '静态 HTML',
        url: '页面 URL',
        urlPlaceholder: 'https://example.com/page',
        pageSlug: '页面标识',
        pageSlugPlaceholder: '如：help-center',
        iconSvg: 'SVG 图标',
        ...
        html: {
          ...
          saved: '无未保存修改',
          unsaved: '有未保存修改',
          invalidFile: '请选择扩展名为 .html 的文件',
          tooLarge: 'HTML 文件不能超过 1 MiB',
