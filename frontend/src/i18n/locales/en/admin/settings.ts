export default {
    settings: {
      ...
      customMenu: {
        ...
        description: 'Add URL, Markdown, or static HTML pages to the sidebar and choose who can see them.',
        itemLabel: 'Menu Item #{n}',
        name: 'Menu Name',
        namePlaceholder: 'e.g. Help Center',
        contentType: 'Content Type',
        contentTypeUrl: 'Page URL',
        contentTypeMarkdown: 'Markdown',
        contentTypeHtml: 'Static HTML',
        url: 'Page URL',
        urlPlaceholder: 'https://example.com/page',
        pageSlug: 'Page Slug',
        pageSlugPlaceholder: 'e.g. help-center',
        iconSvg: 'SVG Icon',
        ...
        html: {
          ...
          invalidFile: 'Choose a file with the .html extension',
          tooLarge: 'The HTML file cannot exceed 1 MiB',
