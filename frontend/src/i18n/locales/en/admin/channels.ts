export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        streamMode: 'Response mode',
        streamModeStreaming: 'Streaming',
        streamModeStreamingHint: 'Request an SSE streaming response.',
        streamModeBuffered: 'Non-streaming',
        streamModeBufferedHint: 'Wait for a complete JSON response.',
        endpoint: 'Endpoint',
