export default {
  ...
  customPage: {
    ...
    htmlLoading: 'Loading page...',
    htmlUnavailable: 'This page is temporarily unavailable.',
  ...
  payment: {
    ...
    statistics: {
      title: 'Order Payment Statistics',
      ...
      query: 'Search',
      range: {
        required: 'Select both a start date and an end date',
        invalid: 'Enter a valid date range',
        reversed: 'The end date cannot be earlier than the start date',
        tooLong: 'The date range cannot exceed 366 days',
      },
      loadError: 'Failed to load order statistics',
      retry: 'Retry',
      empty: 'No paid orders in this date range',
      summary: {
        totalPaid: 'Total paid',
        orderCount: 'Successful orders',
      ...
      details: {
        typeTitle: '{type} order details',
        dateTitle: 'Order details for {date}',
    ...
    admin: {
      ...
      feeRate: 'Fee Rate',
      aggregation: {
        title: 'User Payment Stats',
        user: 'User',
        userPlaceholder: 'Email, username, or user ID',
        startDate: 'Start date',
        endDate: 'End date',
        ...
        query: 'Query',
        timezone: 'Timezone',
        chartAmountHint: 'Amounts are separated by currency',
        amount: 'Payment amount',
        orderCount: 'Orders',
        timelineTitle: 'Payment trend',
        currencyBreakdown: 'Currency breakdown',
        usersTitle: 'User summary',
        resultCount: '{count} user records',
        noData: 'No aggregation data',
        noUsers: 'No matching users',
        loadError: 'Failed to load aggregation data',
        retry: 'Retry',
        statusLabel: {
          paid: 'Paid orders',
          ALL: 'All statuses',
        ...
        summary: {
          ...
          orderCount: 'Orders',
          userCount: 'Users',
          averagePaid: 'Average order value',
        },
        columns: {
          user: 'User',
          currency: 'Currency',
          ...
          orderCount: 'Orders',
          averageAmount: 'Average order value',
        },
        range: {
