...
The sidecar binary was built and validated locally. HC2 deployment is intentionally deferred; this change only adds the online-user feature to the isolated sidecar branch and does not modify or restart Sub2API.
