...
type UserEdges struct {
	...
	// AssignedUsageCards holds the value of the assigned_usage_cards edge.
	AssignedUsageCards []*UserUsageCard `json:"assigned_usage_cards,omitempty"`
...
// was not loaded in eager-loading.
func (e UserEdges) UsageCardsOrErr() ([]*UserUsageCard, error) {
	if e.loadedTypes[4] {
...
// AssignedUsageCardsOrErr returns the AssignedUsageCards value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) AssignedUsageCardsOrErr() ([]*UserUsageCard, error) {
	if e.loadedTypes[5] {
		return e.AssignedUsageCards, nil
	}
	return nil, &NotLoadedError{edge: "assigned_usage_cards"}
}
...
// QueryUsageCards queries the "usage_cards" edge of the User entity.
func (_m *User) QueryUsageCards() *UserUsageCardQuery {
	return NewUserClient(_m.config).QueryUsageCards(_m)
}

// QueryAssignedUsageCards queries the "assigned_usage_cards" edge of the User entity.
func (_m *User) QueryAssignedUsageCards() *UserUsageCardQuery {
	return NewUserClient(_m.config).QueryAssignedUsageCards(_m)
}
