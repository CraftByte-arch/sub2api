...
func (_u *GroupUpdate) SetUsageCardDisabled(v bool) *GroupUpdate {
	_u.mutation.SetUsageCardDisabled(v)
	return _u
}

// SetNillableUsageCardDisabled sets the "usage_card_disabled" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableUsageCardDisabled(v *bool) *GroupUpdate {
	if v != nil {
		_u.SetUsageCardDisabled(*v)
	}
	return _u
}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.UsageCardDisabled(); ok {
...
// SetUsageCardDisabled sets the "usage_card_disabled" field.
func (_u *GroupUpdateOne) SetUsageCardDisabled(v bool) *GroupUpdateOne {
	_u.mutation.SetUsageCardDisabled(v)
	return _u
}

// SetNillableUsageCardDisabled sets the "usage_card_disabled" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableUsageCardDisabled(v *bool) *GroupUpdateOne {
	if v != nil {
		_u.SetUsageCardDisabled(*v)
	}
	return _u
