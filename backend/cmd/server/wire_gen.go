...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	usageCardRepository := repository.NewUsageCardRepository(db)
	usageCardService := service.NewUsageCardService(usageCardRepository, settingRepository)
	settingService := service.ProvideSettingServiceWithUsageCardPlanReader(settingRepository, groupRepository, proxyRepository, usageCardService, configConfig)
	...
	billingCacheService := service.ProvideBillingCacheService(billingCache, userRepository, userSubscriptionRepository, apiKeyRepository, userRPMCache, userGroupRateRepository, usageCardService, configConfig, serviceUserPlatformQuotaRepository)
	...
	apiKeyAuthCacheInvalidator := service.ProvideAPIKeyAuthCacheInvalidator(apiKeyService, usageCardService)
	...
	authService := service.ProvideAuthService(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, tencentCaptchaService, aliyunCaptchaService, emailQueueService, promoService, subscriptionService, affiliateService, serviceUserPlatformQuotaRepository, usageCardService)
	userService := service.NewUserService(userRepository, settingRepository, apiKeyAuthCacheInvalidator, billingCache)
	redeemCache := repository.NewRedeemCache(redisClient)
	redeemService := service.ProvideRedeemService(redeemCodeRepository, userRepository, subscriptionService, redeemCache, billingCacheService, client, apiKeyAuthCacheInvalidator, affiliateService, usageCardService)
	...
	billingService := service.ProvideBillingService(configConfig, pricingService, settingService)
	...
	imageStudioInputStorage := service.ProvideImageStudioInputStorage()
	imageStudioInputStorageHealth := service.ProvideImageStudioInputStorageHealth(imageStudioInputStorage)
	imageStudioJobService := service.ProvideImageStudioJobService(imageStudioJobRepository, settingService, imageStudioInputStorage, imageStudioInputStorageHealth, openAIGatewayService, apiKeyService, billingCacheService, subscriptionService)
	...
	paymentService := service.ProvidePaymentService(client, registry, defaultLoadBalancer, redeemService, subscriptionService, paymentConfigService, userRepository, groupRepository, affiliateService, notificationEmailService, usageCardService)
	...
	firstTokenTimeoutPolicyNotifier := repository.NewFirstTokenTimeoutPolicyNotifier(redisClient)
	...
	asyncAccountPerformanceRecorder := service.NewAccountPerformanceRecorder(accountPerformanceRepository)
	accountPerformanceService := service.NewAccountPerformanceService(accountPerformanceRepository, asyncAccountPerformanceRecorder)
	accountPerformanceHandler := admin.NewAccountPerformanceHandler(accountPerformanceService)
	monitoringHandler := handler.ProvideMonitoringHandler(accountPerformanceService, firstTokenTimeoutStatsRepository, firstTokenTimeoutStatsRecorder)
	...
	usageCardHandler := admin.NewUsageCardHandler(usageCardService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, firstTokenTimeoutHandler, accountPerformanceHandler, monitoringHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, usageCardHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	handlerUsageCardHandler := handler.NewUsageCardHandler(usageCardService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, imageStudioJobHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, handlerUsageCardHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
