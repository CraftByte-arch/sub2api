...
func normalizeHomepageVariant(raw string) string {
	switch strings.ToLower(strings.TrimSpace(raw)) {
	case "aixw":
		return "aixw"
	default:
...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	keys := []string{
		...
		SettingKeyLegacySubscriptionPurchaseEnabled,
		SettingKeyLegacySubscriptionVisible,
		SettingKeyUsageCardEnabled,
		SettingKeyUsageCardPaymentEnabled,
		SettingKeyUsageCardRedeemEnabled,
		SettingKeyUsageCardBillingEnabled,
		SettingKeyUsageCardDefaultPriority,
	...
	return &PublicSettings{
		...
		HomepageVariant:                   normalizeHomepageVariant(os.Getenv("HOMEPAGE_VARIANT")),
		...
		UsageCardDefaultPriority:          normalizeUsageCardDefaultPriority(settings[SettingKeyUsageCardDefaultPriority]),
...
func normalizeUsageCardDefaultPriority(raw string) string {
	priority := NormalizeBillingPriority(strings.TrimSpace(raw))
