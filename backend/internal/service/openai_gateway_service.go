...
type OpenAIForwardResult struct {
	...
	// UpstreamRequestID is the validated audit ID captured for durable settlement,
	// without persisting response headers. It does not replace RequestID for billing deduplication.
