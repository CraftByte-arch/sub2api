...
func (r *usageBatchLogRepoStub) GetByRequestIDAndAPIKey(context.Context, string, int64) (*UsageLog, error) {
	return nil, nil
}
...
func (r *usageBatchLogRepoStub) GetAccountUsageStatsAggregated(context.Context, int64, time.Time, time.Time) (*usagestats.AccountUsageStatsResponse, error) {
	return nil, nil
}
